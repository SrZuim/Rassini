...
export const BIB_TIPO_ESPEC = [
  ...
  { id:'UNID_MIN',   titulo:'Unidimensional (Mínimo)', icon:'bi-arrow-bar-down',
    ...
    campos:['tol_min'] },
  { id:'ATRIBUTO',   titulo:'Verificação (OK/NOK)',    icon:'bi-check2-square',
    desc:'Item de verificação — inspeção visual ou funcional. Sem valores dimensionais; o auditor responde apenas OK ou NOK.',
